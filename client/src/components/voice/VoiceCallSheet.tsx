...
// otherwise reinvent badly.  We pass a Koven-themed palette via
// data attributes so it matches the rest of the app (mostly: the
// UI Kit reads CSS custom properties for its accent colors).
//
// Lifecycle:
