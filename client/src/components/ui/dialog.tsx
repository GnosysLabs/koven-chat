  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        // up the home-indicator inset, plus `--keyboard-inset` (the
        // live soft-keyboard height, published by lib/nativeShell.ts)
        // so the submit button can scroll clear of the keyboard.
        ...
        "max-sm:pb-[calc(env(safe-area-inset-bottom)+1rem+var(--keyboard-inset,0px))]",
