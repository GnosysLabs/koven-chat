...
// invite link without being signed in.  `invite.avatarUrl` is an
// inline data URI resolved server-side by the engine — a signed-out
// visitor has no token to fetch authenticated Synapse media itself.
